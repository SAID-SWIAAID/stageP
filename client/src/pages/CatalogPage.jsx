...
function CatalogPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      setError(err.message || "Error fetching products for catalog.")
    }
  }
    ...
    <Layout>
      <div className="w-full">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-50">Product Catalog</h1>
        </div>

        <Card className="card-container mb-6">
          <CardHeader>
            <CardTitle>Browse Available Products</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            filteredProducts.map((product) => (
              <Card key={product.id} className="card-container">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Available: {product.stock || 0}</p>
